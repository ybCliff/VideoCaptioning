...
def run_all(args, vid, sents):
    ...
    fig.set_size_inches(7, 4)
    fontsize = 12
    f.text(0.12, 0.32, 'GT  : ' + sents[0], fontsize=fontsize)
    f.text(0.12, 0.24, 'NA2E: ' + sents[1], fontsize=fontsize)
    f.text(0.12, 0.16, 'NA-B: ' + sents[2], fontsize=fontsize)
    f.text(0.12, 0.08, 'AR-B: ' + sents[3], fontsize=fontsize)
...
def main(args):
    ...
    ar = pickle.load(open("/home/yangbang/VideoCaptioning/ARVC/AR_topk_collect_results/msvd_1.pkl", 'rb'))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pickle_to_load_captions', type=str, nargs='+', default=[
            "/home/yangbang/VideoCaptioning/ARVC/iterative_collect_results/Youtube2Text_nv_AEmp_i5b5a100.pkl",
            "/home/yangbang/VideoCaptioning/ARVC/iterative_collect_results/Youtube2Text_mp_mp_i5b5a100.pkl"
        ])
    parser.add_argument('--batch_size', type=int, default=1)
    parser.add_argument('--frames_pth', type=str, default='/home/yangbang/VideoCaptioning/Youtube2Text/all_frames/')
    parser.add_argument('--n_frames', type=int, default=4)
    parser.add_argument('--examples_pth', type=str, default='./qualitative_examples_msvd')
