...
def run(params):
    info = json.load(open(params['info_path'])) if params['info_path'] else None
    ...
    for video_path in tqdm(video_path_list):
        ...
        if info is not None:
            video_id = info['vid_to_id'][video_id]
...
--video_path "/home/yangbang/VideoCaptioning/MSRVTT/all_videos/" \
--frame_path "/home/yangbang/VideoCaptioning/MSRVTT/test/" \
--strategy 0 \
--video_suffix mp4 \
--frame_suffix jpg
...
====== msvd =======
python extract_frames_from_videos.py \
--video_path "/home/yangbang/VideoCaptioning/Youtube2Text/all_videos/" \
--frame_path "/home/yangbang/VideoCaptioning/Youtube2Text/test/" \
--info_path "/home/yangbang/VideoCaptioning/Youtube2Text/info_pad_mask_0.json" \
--strategy 0 \
--video_suffix avi \
--frame_suffix jpg
